...
public class HomeController {
	...
	public String calculate(@RequestParam String leftOperand,
		...
		double result = cal.calculateResult();

		model.addAttribute("leftOperand", cal.getLeftOperand());
		model.addAttribute("rightOperand", cal.getRightOperand());
		model.addAttribute("operator", cal.getOperator());
